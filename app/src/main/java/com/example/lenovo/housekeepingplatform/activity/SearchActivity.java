...
import com.example.lenovo.housekeepingplatform.adapter.SearchAdapter;
import com.example.lenovo.housekeepingplatform.db.DBDataHelper;
import com.example.lenovo.housekeepingplatform.db.DBHelper;
...
import com.example.lenovo.housekeepingplatform.util.Util;
...
//                intent.putExtra(ServiceDetailActivity.SERVICE_ID, fundModel.fdcode);

...
public class PartOfSpeech {
    ...
    public final static byte rr = 29;// 代词
    public final static byte rz = 30;// 代词
    public final static byte ry = 31;// 代词
    public final static byte s = 32;// 处所词
    public final static byte t = 33;// 时间词
    public final static byte tg = 34;// 时语素
    public final static byte u = 35;// 助词
    public final static byte ud = 36;// 结构助词
    public final static byte ug = 37;// 时态助词
    public final static byte uj = 38;// 结构助词的
    public final static byte ul = 39;// 时态助词了
    public final static byte uv = 40;// 结构助词地
    public final static byte uz = 41;// 时态助词着
    public final static byte v = 42;// 动词
    public final static byte vd = 43;// 副动词
    public final static byte vg = 44;// 动语素
    public final static byte vn = 45;// 名动词
    public final static byte w = 46;// 标点符号
    public final static byte x = 47;// 非语素字
    public final static byte y = 48;// 语气词
    public final static byte z = 49;// 状态词

    public final static byte unknow = 50; // 未知

    public static String[] names = { "start", "end", "a", "ad", "ag", "an",
            "b", "c", "d", "dg", "e", "f", "g", "h", "i", "j", "k", "l", "m",
            "n", "ng", "nr", "ns", "nt", "nx", "nz", "o", "p", "q", "rr", "rz",
            "ry", "s", "t", "tg", "u", "ud", "ug", "uj", "ul", "uv", "uz", "v",
            "vd", "vg", "vn", "w", "x", "y", "z", "unknow" };

...
import com.example.lenovo.housekeepingplatform.adapter.DiscoverLeve1Adapter;
import com.example.lenovo.housekeepingplatform.adapter.DiscoverLevel2Adapter;
import com.example.lenovo.housekeepingplatform.adapter.OnExRvItemViewClickListener;
import com.example.lenovo.housekeepingplatform.decoration.DiscoverIndexLevel2Decoration;
import com.example.lenovo.housekeepingplatform.manager.TopSnappedLayoutManager;
import com.example.lenovo.housekeepingplatform.module.classfiy.DiscoverIndexResult;
...
import com.example.lenovo.housekeepingplatform.util.DiscoverIndexUtil;
...
public class ClassifyFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mContentView = inflater.inflate(R.layout.fragment_shopcar_layout, container, false);
        initview();
        return mContentView;
    }
    ...
    private void initLevel1Views() {
        mErvLevel1 = (RecyclerView)mContentView.findViewById(R.id.ervLevel1);
        ...
        mLevel1LayoutMgr = new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false);
    ...
    private void initLevel2Views() {
        mErvLevel2 = (RecyclerView)mContentView.findViewById(R.id.ervLevel2);
        ...
        mLevel2LayoutMgr = new TopSnappedLayoutManager(mContext, 3, GridLayoutManager.VERTICAL, false);
    ...
    private void onRvItemLevel2ViewClick(int dataPos) {
        ...
        if (object instanceof DiscoverOper) {
            Intent serviceintent = new Intent(mContext, ServiceDetailActivity.class);
            serviceintent.putExtra("SERVICE_TITLE",((DiscoverOper) object).getTitle());
            serviceintent.putExtra("SERVICE_SUB_TITLE",((DiscoverOper) object).getSubtitle());
            serviceintent.putExtra("SERVICE_PIC",((DiscoverOper) object).getIndex());
            serviceintent.putExtra("SERVICE_TIME",((DiscoverOper) object).getTime());
            serviceintent.putExtra("SERVICE_PRICE",((DiscoverOper) object).getPrice());
            startActivity(serviceintent);
//            Toast.makeText(mContext, String.format("点击%s", ((DiscoverOper) object).getTitle()), Toast.LENGTH_LONG).show();
        }
    }

package com.example.lenovo.housekeepingplatform.fresco;
...
import com.example.lenovo.housekeepingplatform.util.StorageUtil;
...
public class FrescoInitUtil {
    ...
    public static void initFrescoConfig() {
        ...
        ImagePipelineConfig pipeConfig = ImagePipelineConfig.newBuilder(housekeepingApplication.getContext())
                ...
                //设置磁盘缓存项配置
                .setMainDiskCacheConfig(getDisCacheConfigDefault(housekeepingApplication.getContext()))
                .setSmallImageDiskCacheConfig(getDisCacheConfigSmall(housekeepingApplication.getContext()))
        ...
        FrescoIniter.initialize(housekeepingApplication.getContext(), pipeConfig);
    ...
    public static class BitmapCacheParamsSupplier implements Supplier<MemoryCacheParams> {
        ...
        public MemoryCacheParams get() {
            ...
            mActivityManager = (ActivityManager) housekeepingApplication.getContext().getSystemService(Context.ACTIVITY_SERVICE);

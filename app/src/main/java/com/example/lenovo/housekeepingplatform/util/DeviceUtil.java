...
public class DeviceUtil {
    ...
    public static int getScreenWidth() {
        ...
        if (mScreenWidth == 0)
            ...
            mScreenWidth = housekeepingApplication.getContext().getResources().getDisplayMetrics().widthPixels;
    ...
    public static int getScreenHeight() {
        ...
        if (mScreenHeight == 0)
            mScreenHeight = housekeepingApplication.getContext().getResources().getDisplayMetrics().heightPixels;
